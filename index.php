...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Smart Point of Sale for Modern Business</h1>
            <p>Streamline your checkout process, manage inventory in real-time, and grow your sales seamlessly with
                QuickPOS.</p>
            <div class="hero-buttons">
                <a href="#demo" class="btn btn-primary">Get a Free Demo</a>
                <a href="#features" class="btn btn-secondary">Learn More</a>
            </div>
        </div>
        <div class="hero-image">
